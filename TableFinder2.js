...
['영어 독해와 작문', '일본어 독해와 작문I', 'AP 통계학', '영미문학II', '생명과학II', '전자기학 및 실험', '심화 미분적분학II', '수학II', '수학II', '심화 영어 독해II', '문학'],
['중국 언어와 문화', '선형대수학', 'AP 거시경제', 'AP 생물학II', 'AP 화학 II', '심화 미분적분학II', '미적분학I', '수학II', '심화 영어 독해II', '문학'],
['AP 세계사', 'AP 생물학II', '화법과 작문', 'AP 거시경제', '전자기학 및 실험', 'AP 화학 II', '미적분학I', '미적분학I', '심화 미분적분학II', '문학'],
['심화 영어 회화I', '화학II', '현대사회와 철학', 'AP 통계학', '생명과학II', 'AP 화학 II', '미적분학I', '수학II', '문학'],
['지구과학II', '화학II', '현대사회와 철학', '전자기학 및 실험', '수학II', '수학II', '심화 영어 독해II', '문학'],
['영미문학II', 'AP 화학 II', '문학', '수학II'],
['국제정치', '미적분학I', '심화 영어 독해II'],
['과학과제 연구(수학통계)', '퍼블릭스피킹과 프리젠테이션', 'AP 컴퓨터과학 A', '논술', '과학과제 연구(물화지정)', '과학과제 연구(생명과학)', '사회과제 연구', '경제', '운동과 건강', '운동과 건강'],
['사회과제 연구', '입체 조형', '과학과제 연구(생명과학)', '교육학', '사회과제 연구', '경제'],
['논술', '과학과제 연구(물화지정)', '과학과제 연구(물화지정)', '과학과제 연구(생명과학)', '교육학', '사회과제 연구', '경제'],
['동아시아사', '입체 조형', '사회과제 연구', '경제', '운동과 건강', '운동과 건강'],
['고전문학 감상', 'AP 컴퓨터과학 A', '과학과제 연구(물화지정)', '과학과제 연구(생명과학)', '교육학', '경제']];
/** USE PARSING TOOL **/
