...
['사회과제 연구(인문학)', '과학과제 연구(수학통계)', '문학과 매체', '과학과제 연구(물리)+(정보전산)', '과학과제 연구(생명과학)', '생활과 과학', '사회과제 연구(사회과학)', '경제', '운동과 건강', '운동과 건강', '운동과 건강', '운동과 건강'],
['과학과제 연구(물리)+(정보전산)', '생활과 과학', '사회과제 연구(사회과학)', '경제', '운동과 건강'],
['동아시아사', '과학과제 연구(화학+지구환경)', '음악사(무학년)', '과학과제 연구(생명과학)', '사회과제 연구(사회과학)', '경제', '운동과 건강'],
['과학과제 연구(화학+지구환경)', '과학과제 연구(물리)+(정보전산)', '과학과제 연구(생명과학)', '경제']];
/** USE PARSING TOOL **/
...
function set(time, subName) {
    ...
    case 1:
        ...
        tempTable[0][5] = subName;
        tempTable[2][2] = subName;
        tempTable[2][3] = subName;
        break;
    case 2:
        tempTable[0][6] = subName;
        tempTable[1][6] = subName;
    ...
    case 4:
        ...
        tempTable[3][5] = subName;
        break;
    case 5:
        tempTable[1][4] = subName;
        tempTable[1][5] = subName;
        tempTable[3][6] = subName;
        tempTable[4][6] = subName;
        break;
    case 6:
        tempTable[2][0] = subName;
        tempTable[2][1] = subName;
        tempTable[4][4] = subName;
        tempTable[4][5] = subName;
        break;
    case 7:
        tempTable[2][4] = subName;
        tempTable[2][5] = subName;
